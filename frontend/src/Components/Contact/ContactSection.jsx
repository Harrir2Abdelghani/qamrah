...
const ContactSection = () => {
  return (
    <div className="bg-white p-6 md:p-12 lg:px-24 text-gray-800">
      ...
      <div className="mt-12 max-w-3xl mx-auto bg-rose-50 p-6 rounded-lg shadow-lg">
      ...
      <div className="mt-16 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-12">
          <div className="flex items-center space-x-3">
            ...
            <p className="text-gray-600">support@qamrah.com</p>
          </div>
          <div className="flex items-center space-x-3">
            <FaPhoneAlt className="text-deepPlum text-2xl" />
            <p className="text-gray-600">+213 665958010</p>
          </div>
          <div className="flex items-center space-x-3">
            <FaMapMarkerAlt className="text-deepPlum text-2xl" />
            <p className="text-gray-600">123 Ain El Hadid, Tiaret</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        ...
        <div className="flex justify-center space-x-6">
          <a href="https://www.facebook.com/lamia.gue.77/?_rdr" target="_blank" className="text-deepPlum  hover:text-indigo-600 transition-colors">
            <FaFacebook size={32} />
          </a>
          <a href="https://www.instagram.com/lamia._.za/" target="_blank" className="text-deepPlum hover:text-indigo-600 transition-colors">
            <FaInstagram size={32} />
          </a>
          <a href="mailto:support@qamrah.com" target="_blank" className="text-deepPlum hover:text-indigo-600 transition-colors">
            <FaEnvelope size={32} />
          </a>
        </div>
      </div>
      ...
      <div className="mt-16 max-w-3xl mx-auto">
        <h3 className="text-3xl font-semibold mb-6 text-center text-deepPlum font-dancing">Frequently Asked Questions</h3>
      ...
      <div className="mt-16 text-center">
        ...
        <div className="space-y-4">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            <p className="text-gray-600 italic ">"Amazing customer service and beautiful dresses! Highly recommend Qamrah!"</p>
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className=" font-semibold mt-2 text-roseGold">- Nour G.</p>
          </div>
        </div>
      </div>
      <hr className="border-t-2 border-roseGold mt-20 w-1/2 mx-auto" />
