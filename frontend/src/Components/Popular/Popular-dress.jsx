...
function Popular({ data_dress_product }) {
...
>
<hr className="border-t-2 border-roseGold mb-8" />
  ...
  {data_dress_product.map((item) => (
    ...
    >
      {/* Product Image */}
      <div className="relative w-full h-64 overflow-hidden rounded-lg mb-5 md:mb-0 lg:mb-5 md:mr-5 lg:mr-0">
        <img
          src={item.image}
          alt={item.name}
